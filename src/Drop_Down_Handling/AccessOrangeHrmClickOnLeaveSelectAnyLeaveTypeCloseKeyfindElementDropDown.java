...
public class AccessOrangeHrmClickOnLeaveSelectAnyLeaveTypeCloseKeyfindElementDropDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//span[text()='Development']")).click();
		
		driver.findElement(By.xpath("(//div[@class='oxd-select-text-input'])[2]")).click();
		Thread.sleep(3000);
		List<WebElement> leave=driver.findElements(By.xpath("//div[@class='oxd-select-dropdown --positon-bottom']"));
		for(WebElement leaves:leave)
			System.out.println(leaves.getText());
