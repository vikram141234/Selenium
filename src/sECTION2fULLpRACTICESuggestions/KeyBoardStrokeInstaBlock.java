...
public class KeyBoardStrokeInstaBlock {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath("(//div[@class='_abm0'])[4]")).click();
		driver.findElement(By.xpath("//div[text()='Block']")).click();
		driver.findElement(By.xpath("//button[text()='Block']")).click();
		Thread.sleep(3000);	
		driver.findElement(By.xpath("//button[@class='_a9-- _a9-_']")).click();
